...
```**POST FOR 4/4/22'**
    *KENDO.BOT UPDATES*
    - KENDO.BOT'S OFFICIAL BIRTHDAY
    - BASIC BOT STRUCTURE IN PLACE
    - TICKET SYSTEM DEVELOPMENT HAS BEGUN
    - READY FOR RECCOMENDATIONS (FEATURE-WISE)
    *WATCHPARTY UPDATES*
    - SCHEDULING WILL BE SET UP AND THE FIRST ANIME SHALL BE SELSECTED FOR THE WATCHPARTY BETWEEN 4/4/22 11:45PM EST AND 4/5/22 11:45PM EST
```
```~SENJI```